										...
										<div class="guide-item-container personal-item">
											<ul class="guide-user-links yt-uix-tdl yt-box">
												...
												<li
													...
													id="UCkwKXIFgDWCJkuTJbkg227A-guide-item"><a
													class="guide-item yt-uix-sessionlink yt-valign spf-link   "
													href="<?php echo RwsConstant::FULL_BASE_URL_HOST . "/bdsKhachHangList";?>"
													title="My Channel"> <span class="yt-valign-container"> <span
															class="thumb guide-my-channel-icon yt-sprite"></span> <span
															class="display-name  no-count"> <span> <?php echo  $scrFieldLabels['SCR_MENU_BDS_CUS_LIST'];?> </span>
														</span>
													</span>
												</a></li>
												<?php 
												...
												<li
													...
													id="UCkwKXIFgDWCJkuTJbkg227A-guide-item"><a
													class="guide-item yt-uix-sessionlink yt-valign spf-link   "
													href="<?php echo RwsConstant::FULL_BASE_URL_HOST . "/bdsKhachHang";?>"
													title="My Channel"> <span class="yt-valign-container"> <span
															class="thumb guide-my-channel-icon yt-sprite"></span> <span
															class="display-name  no-count"> <span> <?php echo  $scrFieldLabels['SCR_MENU_BDS_CUS'];?> </span>
														</span>
													</span>
												</a></li>
												<?php 

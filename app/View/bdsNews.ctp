...
$(function() {
	fnc_madeAddress();
	$( "#id_bdsnews_published_bat_dau" ).datepicker();
	$( "#id_bdsnews_published_bat_dau" ).on( "change", function() {
      $( "#id_bdsnews_published_bat_dau" ).datepicker( "option", "dateFormat", "dd/mm/yy" );
    });
    $( "#id_bdsnews_bds_gia_re_bat_dau" ).datepicker();
    $( "#id_bdsnews_bds_gia_re_bat_dau" ).on( "change", function() {
      $( "#id_bdsnews_bds_gia_re_bat_dau" ).datepicker( "option", "dateFormat", "dd/mm/yy" );
    });
    $( "#id_bdsnews_bds_tin_vip_bat_dau" ).datepicker();
    $( "#id_bdsnews_bds_tin_vip_bat_dau" ).on( "change", function() {
      $( "#id_bdsnews_bds_tin_vip_bat_dau" ).datepicker( "option", "dateFormat", "dd/mm/yy" );
    });
});
                	...
                	<?php 
                		...
                		<label>
							...
							echo $this->Form->input ( '', array (
											...
											'label' => false,
											'div' => false,
											'checked' => $bdsNews['BdsNews']['REMOVE_BDS_FLG']
								) );
                ...
                <div class="controls">
	                <?php 
                		...
                		echo $this->Form->input ( '', array (
											...
											'label' => false,
											'div' => false,
											'checked' => $bdsNews['BdsNews']['BY_GROUP']
								) );
                    ...
                    <label class="w180">
                		<?php 
                			echo $this->Form->input ( '', array (
											...
											'label' => false,
											'div' => false,
											'checked' => $bdsNews['BdsNews']['TIN_DANG_ID_PUBLISHED']
								) );
                		?>
                    	Published
                    </label>
                    ...
                    <label class="w180">
                		<?php 
                			echo $this->Form->input ( '', array (
											...
											'label' => false,
											'div' => false,
											'checked' => $bdsNews['BdsNews']['BDS_GIA_RE']
								) );
                		?>BĐS giá rẻ</label>
                        ...
                        <label class="w99">
                        	<?php 
		                			echo $this->Form->input ( '', array (
													...
													'label' => false,
													'div' => false,
													'checked' => $bdsNews['BdsNews']['BDS_DANG']
										) );
		                		?>BĐS đăng</label>
                        <!-- Type VIP -->
                        <?php 
                ...
                <div class="controls">
                     ...
                     <?php 
                     	echo $this->Form->input ( '', array (
											...
											'label' => false,
											'div' => false,
											'checked' => $bdsNews['BdsNews']['PUBLISH_ADDRESS']
								) );
                    ...
                    <div class="controls">
                        <?php 
									echo $this->Form->input('', array(
										 ...
										 'value' => $bdsNews['BdsNews']['DIEN_TICH_XAY']
								));?> m<sup>2</sup>
                    </div>
                </div>
                    ...
                    <div class="controls">
                        <?php 
									echo $this->Form->input('', array(
										 ...
										 'div' => false,
										 'class' => 'text number-box-ext',
										 'value' => $bdsNews['BdsNews']['DIEN_TICH_SAN']
								));?> m<sup>2</sup>
                    </div>
                </div>
                ...
                <div class="control-group">
                    ...
                    <?php 
								...
								echo $this->Form->select ( '', $option, array(
									...
									'class' => 'select-box',
									'value' => $bdsNews['BdsNews']['SO_TANG_CODE']
								));
							?>
                    </div>
                </div>
                    ...
                    <div class="controls">
                    		<?php 
									echo $this->Form->input('', array(
										 ...
										 'div' => false,
										 'class' => 'text number-box-ext',
										 'value' => $bdsNews['BdsNews']['SO_PHONG_NGU']
									));
								?>	
                    </div>
                </div>
                    ...
                    <div class="controls">
                    		<?php 
									echo $this->Form->input('', array(
										 ...
										 'div' => false,
										 'class' => 'text number-box-ext',
										 'value' => $bdsNews['BdsNews']['SO_PHONG_TOLET']
									));
								?>	
                    </div>
                </div>
                    ...
                    <div class="controls">
	                    <?php 
									...
									echo $this->Form->select ( '', $option, array(
										...
										'class' => 'select-box',
										'value' => $bdsNews['BdsNews']['LOAI_CONG_TRINH_CODE']
									));
								?>
                    </div>
                </div>
                    ...
                    <div class="controls">
                    		<?php 
									...
									echo $this->Form->select ( '', $option, array(
										...
										'class' => 'select-box',
										'value' => $bdsNews['BdsNews']['MUC_XAY_CODE']
									));
								?>
                    </div>
                </div>
                    ...
                    <div class="controls">
                    		<?php 
									echo $this->Form->input('', array(
										 ...
										 'div' => false,
										 'class' => 'text number-box-ext',
										 'value' => $bdsNews['BdsNews']['CHAT_LUONG_NHA']
									));
								?> %
                    </div>
                </div>
                ...
                <ul style="padding-left:40px;">
                    <li><label>
						 <?php 
							echo $this->Form->input ( '', array (
										...
										'label' => false,
										'div' => false,
										'checked' => $bdsNews['BdsNews']['CO_HAM']
							) );
                    ...
                    <?php 
								echo $this->Form->input ( '', array (
											...
											'label' => false,
											'div' => false,
											'checked' => $bdsNews['BdsNews']['CO_LUNG']
								) );
							?>Có lửng</label></li>
                    <li><label>
                    	<?php 
								echo $this->Form->input ( '', array (
											...
											'label' => false,
											'div' => false,
											'checked' => $bdsNews['BdsNews']['CO_SAN_THUONG']
								) );
                    ...
                    <?php 
								echo $this->Form->input ( '', array (
											...
											'label' => false,
											'div' => false,
											'checked' => $bdsNews['BdsNews']['CO_GARA_OTO']
								) );
                    ...
                    <?php 
								echo $this->Form->input ( '', array (
											...
											'label' => false,
											'div' => false,
											'checked' => $bdsNews['BdsNews']['CO_THANG_MAY']
								) );
                    ...
                    <?php 
								echo $this->Form->input ( '', array (
											...
											'label' => false,
											'div' => false,
											'checked' => $bdsNews['BdsNews']['CO_HO_BOI']
								) );
							?>Có hồ bơi</label></li>
                </ul>
            </div>
                	...
                	<label>
						 <?php 
							echo $this->Form->input ( '', array (
										...
										'label' => false,
										'div' => false,
										'checked' => $bdsNews['DiemTot']['HAI_MAT_DUONG']
							) );
                ...
                <li>
                	...
                	<?php 
							echo $this->Form->input ( '', array (
										...
										'label' => false,
										'div' => false,
										'checked' => $bdsNews['DiemTot']['HEM_BEN_HONG']
							) );
                	...
                	<label>
                		<?php 
								echo $this->Form->input ( '', array (
											...
											'label' => false,
											'div' => false,
											'checked' => $bdsNews['DiemTot']['HEM_SAU_NHA']
								) );
							?>Có hẻm sau nhà (+5%)
							</label>
                </li>
                <li>
	                	...
	                	<?php 
								echo $this->Form->input ( '', array (
											...
											'label' => false,
											'div' => false,
											'checked' => $bdsNews['DiemTot']['GAN_CHO_SIEU_THI']
								) );
                ...
                <li>
	                	...
	                	<?php 
								echo $this->Form->input ( '', array (
											...
											'label' => false,
											'div' => false,
											'checked' => $bdsNews['DiemTot']['GAN_CONG_VIEN_MALL']
								) );
                ...
                <li>
	                	...
	                	<?php 
								echo $this->Form->input ( '', array (
											...
											'label' => false,
											'div' => false,
											'checked' => $bdsNews['DiemTot']['CONG_BAO_VE']
								) );
                ...
                <li>
	                	...
	                	<?php 
								echo $this->Form->input ( '', array (
											...
											'label' => false,
											'div' => false,
											'checked' => $bdsNews['DiemTot']['VI_TRI_DEP']
								) );
                ...
                <li>
	                	...
	                	<?php 
								echo $this->Form->input ( '', array (
											...
											'label' => false,
											'div' => false,
											'checked' => $bdsNews['DiemTot']['TIEN_MO_QUAN']
								) );
                ...
                <li>
	                	...
	                	<?php 
								echo $this->Form->input ( '', array (
											...
											'label' => false,
											'div' => false,
											'checked' => $bdsNews['DiemTot']['HEM_THONG']
								) );
                    ...
                    <div class="controls">
                    		<?php 
									echo $this->Form->input('', array(
										 ...
										 'div' => false,
										 'class' => 'text text-box-medium',
										 'value' => $bdsNews['DiemTot']['DIEM_TOT_KHAC']
									));
								?>	
                    </div>
                </div>
                    ...
                    <div class="controls">
                    		<?php 
									echo $this->Form->input('', array(
										 ...
										 'value' => $bdsNews['DiemTot']['PHAN_TRAM_TANG']
									));
								?>	%
                    </div>
                </div>
                ...
                <li>
	                	...
	                	<?php 
								echo $this->Form->input ( '', array (
											...
											'label' => false,
											'div' => false,
											'checked' => $bdsNews['DiemXau']['DUONG_DAM_VAO_NHA']
								) );
                ...
                <li>
	                	...
	                	<?php 
								echo $this->Form->input ( '', array (
											...
											'label' => false,
											'div' => false,
											'checked' => $bdsNews['DiemXau']['GAN_CHUA_NHA_THO']
								) );
                ...
                <li>
	                	...
	                	<?php 
								echo $this->Form->input ( '', array (
											...
											'label' => false,
											'div' => false,
											'checked' => $bdsNews['DiemXau']['GAN_NHA_TANG_LE']
								) );
                ...
                <li>
	                	...
	                	<?php 
								echo $this->Form->input ( '', array (
											...
											'label' => false,
											'div' => false,
											'checked' => $bdsNews['DiemXau']['CHAN_CAU_CAO_THE']
								) );
                ...
                <li>
	                	...
	                	<?php 
								echo $this->Form->input ( '', array (
											...
											'label' => false,
											'div' => false,
											'checked' => $bdsNews['DiemXau']['CONG_TRUOC_NHA']
								) );
							?>Có cống trước nhà (-5%)
                    </label>
                </li>
                <li>
	                	...
	                	<?php 
								echo $this->Form->input ( '', array (
											...
											'label' => false,
											'div' => false,
											'checked' => $bdsNews['DiemXau']['TRU_DIEN_TRUOC_NHA']
								) );
                ...
                <li>
	                	...
	                	<?php 
								echo $this->Form->input ( '', array (
											...
											'label' => false,
											'div' => false,
											'checked' => $bdsNews['DiemXau']['CAY_LON_TRUOC_NHA']
								) );
                ...
                <li>
	                	...
	                	<?php 
								echo $this->Form->input ( '', array (
											...
											'label' => false,
											'div' => false,
											'checked' => $bdsNews['DiemXau']['KHONG_THE_XAY_MOI']
								) );
                ...
                <li>
	                	...
	                	<?php 
								echo $this->Form->input ( '', array (
											...
											'label' => false,
											'div' => false,
											'checked' => $bdsNews['DiemXau']['QUY_HOACH_TREO']
								) );
                    ...
                    <div class="controls">
                        <?php 
									echo $this->Form->input('', array(
										 ...
										 'div' => false,
										 'class' => 'text text-box-medium',
										 'value' => $bdsNews['DiemXau']['DIEM_XAU_KHAC']
									));
								?>	
                    </div>
                </div>
                    ...
                    <div class="controls">
                        <?php 
									echo $this->Form->input('', array(
										 ...
										 'div' => false,
										 'class' => 'text number-box',
										 'value' => $bdsNews['DiemXau']['PHAN_TRAM_GIAM']
									));
								?>	%
                    </div>
                </div>
                ...
                <div class="controls">
                		<?php 
								echo $this->Form->input('', array(
									 ...
									 'div' => false,
									 'class' => 'text text-box-medium',
									 'value' => $bdsNews['BdsNews']['TEN_DIEN_THOAI']
								));
							?>                       
						<label>
						 <?php 
							echo $this->Form->input ( '', array (
										...
										'label' => false,
										'div' => false,
										'checked' => $bdsNews['BdsNews']['CHO_HIEN_TEN_DIEN_THOAI']
							) );
                ...
                <div class="controls">
                		<?php 
								echo $this->Form->input('', array(
									 ...
									 'div' => false,
									 'class' => 'text text-box-medium',
									 'value' => $bdsNews['BdsNews']['TEN_LIEN_HE']
								));
							?>
                </div>
            </div>
                ...
                <div class="controls">
                    <?php 
								echo $this->Form->input('', array(
									 ...
									 'div' => false,
									 'class' => 'text text-box-medium',
									 'value' => $bdsNews['BdsNews']['DIA_CHI_LIEN_HE']
								));
							?>
                </div>
            </div>
                ...
                <div class="controls">
                    <?php 
								echo $this->Form->input('', array(
									 ...
									 'div' => false,
									 'class' => 'text text-box-medium',
									 'value' => $bdsNews['BdsNews']['EMAIL_LIEN_HE']
								));
							?>
                </div>
            </div>
                    ...
                    <label>
							 <?php 
								echo $this->Form->input ( '', array (
											...
											'label' => false,
											'div' => false,
											'checked' => $bdsNews['BdsNews']['TIN_CHINH_CHU']
								) );
							?>Tin chính chủ</label>
                    <label>
                    <?php 
								echo $this->Form->input ( '', array (
											...
											'label' => false,
											'div' => false,
											'checked' => $bdsNews['BdsNews']['MIEN_TRUNG_GIAN']
								) );
                    ...
                    <label>
                    	<?php 
								echo $this->Form->input ( '', array (
											...
											'label' => false,
											'div' => false,
											'checked' => $bdsNews['BdsNews']['BDS_PHAT_MAI']
								) );
							?>BĐS phát mãi</label>
                </div>
            </div>
                    ...
                    <div class="controls">
                    	<?php 
								echo $this->Form->input('', array(
									 ...
									 'div' => false,
									 'class' => 'text text-box-medium',
									 'value' => $bdsNews['BdsNews']['LIEN_HE_DOC_QUYEN']
								));
							?>
                    </div>
                </div>
                    ...
                    <label>
                    	<?php 
								echo $this->Form->input ( '', array (
											...
											'label' => false,
											'div' => false,
											'checked' => $bdsNews['BdsNews']['THUONG_LUONG']
								) );
                ...
                <div class="controls">
                		<?php 
								...
								echo $this->Form->select ( '', $option, array(
									...
									'class' => 'select-box',
									'value' => $bdsNews['BdsNews']['LOAI_TIEN_CODE']
								));
								...
								echo $this->Form->select ( '', $option, array(
									...
									'class' => 'select-box',
									'value' => $bdsNews['BdsNews']['DON_VI_DO_CODE']
								));
							?>
                ...
                <div class="controls">
                		<?php
								echo $this->Form->input('', array(
									 ...
									 'value' => $bdsNews['BdsNews']['HINH_DANG']
								));
							?>	
                </div>
            </div>
                ...
                <div class="controls">
                		<?php
                			echo $this->Form->input('', array(
									 ...
									 'class' => 'text text-box-medium',
									 'placeholder' => 'VD: 2',
									 'value' => $bdsNews['BdsNews']['MAT_TIEP_GIAP']
								));
							?>
                </div>
            </div>
                ...
                <div class="controls">
                		<?php
								echo $this->Form->input('', array(
									 ...
									 'value' => $bdsNews['BdsNews']['MOI_TRUONG_SONG']
								));
							?>
                </div>
            </div>
                ...
                <div class="controls">
                    <?php
								echo $this->Form->input('', array(
									 ...
									 'div' => false,
									 'class' => 'text text-box-medium',
									 'value' => $bdsNews['BdsNews']['DON_GIA_DAT']
								));
							?>
                </div>
            </div>
                ...
                <div class="controls">
                		<?php
								echo $this->Form->input('', array(
									 ...
									 'div' => false,
									 'class' => 'text text-box-medium',
									 'value' => $bdsNews['BdsNews']['DON_GIA_XAY']
								));
							?>
                </div>
            </div>
                ...
                <div class="controls">
                    <?php
								echo $this->Form->input('', array(
									 ...
									 'div' => false,
									 'class' => 'text number-box',
									 'value' => $bdsNews['BdsNews']['GIA_DU_KIEN']
								));
							?>

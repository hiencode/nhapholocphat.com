...
/**
 * Maintenance Status
 * 1: App is under maintain
 * 0: OK
 */
	Configure::write('maintenance_flag', 0);
 ...
 */
	Configure::write('Security.salt', 'FEHjkdgjh*&(*623784JHI98788jhjeqapov<xmzcnsjkvsagsi289347056786!#$@##@*&^)(*#)&*%^@389jksdhf8436^&^#(0nkv');

/**
 * A random numeric string (digits only) used to encrypt/decrypt strings.
 */
	Configure::write('Security.cipherSeed', '6783546546542323002346795456787455468798798212346523687987975456798975452124795456');
